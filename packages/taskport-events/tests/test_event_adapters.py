...
from taskport_events import Event, EventCapability
from taskport_events.adapters.aws import EventBridgePublisher, SnsPublisher
from taskport_events.adapters.azure import EventGridPublisher
from taskport_events.adapters.kafka import KafkaPublisher
...
def test_sns_publish_builds_message_and_attributes() -> None:
    ...
    assert sent["MessageAttributes"]["taskport-event-type"]["StringValue"] == "order.placed"
...
def test_eventbridge_raises_on_failed_entries() -> None:
    ...
    from taskport.core import ProviderError
