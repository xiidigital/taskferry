...
- `CeleryTaskBackend` — sends Taskport tasks to a Celery app via `send_task`,
...
- `taskport.backends` entry point (`celery`). Contract-tested with a fake app;
