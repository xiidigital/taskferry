...
Taskport exists precisely so that is a configuration change.
...
from ..errors import ExecutionNotFound, TaskportTimeoutError
...
class ThreadTaskBackend(BaseBackend):
    ...
    def __init__(
        ...
        *,
        ...
        self._pool = ThreadPoolExecutor(max_workers=max_workers, thread_name_prefix="taskport-task")
