"""Taskferry on AWS SQS — pull-based task delivery.
...
SQS is the third shape of task engine Taskferry adapts, and the differences from
...
Taskferry supplies no worker daemon here either — a Lambda, an ECS service or a
simple polling loop you already run is the consumer, and SQS handles visibility
timeouts and redrive. See :mod:`taskferry_sqs.consumer`.
"""
