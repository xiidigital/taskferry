"""Taskport on Google Cloud Tasks — push-based, serverless task execution.

```mermaid
sequenceDiagram
    participant App
    participant TP as Taskport
    participant AD as taskport_cloudtasks
...
bare WSGI app in four lines. See :mod:`taskport_cloudtasks.receiver`.
"""
